---
title: "Triển khai mã nguồn và Web Server"
date : 2024-01-01 
weight : 3
chapter : false
pre: " <b> 5.3. </b> "
...
![ec2](/images/5-Workshop/5.3-Deploy-Config/12.png)

+ Vào Instance và bấm connect

![ec2](/images/5-Workshop/5.3-Deploy-Config/13.png)

+ Check status 3/3 và chọn SSM Session Manager

![ec2](/images/5-Workshop/5.3-Deploy-Config/14.png)

+ Bấm connect

![ec2](/images/5-Workshop/5.3-Deploy-Config/15.png)

+ Sau khi bấm connect sẽ tự động chuyển sang system manager

![ec2](/images/5-Workshop/5.3-Deploy-Config/16.png)
